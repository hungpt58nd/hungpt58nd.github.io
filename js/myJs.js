...
function textGenerate() {
    var n = "";
    var text = " Bác sĩ đáng yêu nhất quả đất cho riêng 1 người hihi :p";
    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Tối nay anh chở em về nhaaaaaaaaa :v Inbox cho anh đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://app.slack.com/client/T03G4RS4R/D62RW31UZ';
                  }
            })
        }
    })
